...
filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates audit records upon successful/unsuccessful attempts to use the "umount" command
...
Note: The "-k <keyname>" at the end of the line gives the rule a unique meaning to help during an audit investigation. The <keyname> does not need to match the example above.'
  ...
  tag gid: 'V-238255'
  tag rid: 'SV-238255r958446_rule'
  tag stig_id: 'UBTU-20-010139'
  tag fix_id: 'F-41424r951494_fix'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
  tag 'host'
