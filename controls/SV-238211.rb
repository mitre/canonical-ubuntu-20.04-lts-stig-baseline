control 'SV-238211' do
  ...
  desc 'check', %q(Verify the Ubuntu operating system is configured to use strong authenticators in the establishment of nonlocal maintenance and diagnostic maintenance.
...
UsePAM yes'
  impact 0.5
  tag check_id: 'C-41421r951463_chk'
  tag severity: 'medium'
  tag gid: 'V-238211'
  tag rid: 'SV-238211r958510_rule'
