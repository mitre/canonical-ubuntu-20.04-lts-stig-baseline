...
to users who are no longer authorized (users with revoked certificates).'
  desc 'check', %q(Verify the Ubuntu operating system, for PKI-based authentication, uses local revocation
...
If the system is missing an "/etc/pam_pkcs11/" directory and an "/etc/pam_pkcs11/pam_pkcs11.conf", find an example to copy into place and modify accordingly at "/usr/share/doc/libpam-pkcs11/examples/pam_pkcs11.conf.example.gz".'
  ...
  tag gid: 'V-238233'
  tag rid: 'SV-238233r1015151_rule'
  tag stig_id: 'UBTU-20-010066'
  tag fix_id: 'F-41402r880869_fix'
